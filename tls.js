const net = require("net");
 ...
 Example: node tls.js https://example.com/ 120 64 8 proxy.txt
...
headers.push({ "Alt-Svc": "http/1.1=" + parsedTarget.host + "; ma=7200" }); 
headers.push({ "Alt-Svc": "http/1.2=" + parsedTarget.host + "; ma=7200" }); 
headers.push({ "Alt-Svc": "http/2=" + parsedTarget.host + "; ma=7200" }); 
headers.push({ "Alt-Svc": "http/1.1=http2." + parsedTarget.host + ":80; ma=7200" }); 
headers.push({ "Alt-Svc": "http/1.2=http2." + parsedTarget.host + ":80; ma=7200" }); 
headers.push({ "Alt-Svc": "http/2=http2." + parsedTarget.host + ":80; ma=7200" }); 
headers.push({ "Alt-Svc": "http/1.1=" + parsedTarget.host + ":443; ma=7200" }); 
headers.push({ "Alt-Svc": "http/1.2=" + parsedTarget.host + ":443; ma=7200" }); 
